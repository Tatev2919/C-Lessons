...
int main(){
	...
	regex name ("\\b([A-Z][a-z]{1,}\\s(?!Mkh)[A-Z][a-z]{1,}(ian|yan|uni|enc|deh|toc))\\b");
	regex ipv4("(((25[0-5])|(2[0-4][0-9])|(1[0-9]{2})|([1-9][0-9])|([0-9]))\\.){3}((25[0-5])|(2[0-4][0-9])|(1[0-9]{2})|([1-9][0-9])|([0-9]))");
	...
	string ip6_t = "IPv6 form is : 0FFF:2F:AB:570:4F:1a:FFFF:78 or 15:FFFa:2a:97B:1a:48D:47:255 or 25a:2f5:2:147:444a:5D:47c:12a but not 15::4b5:47a:49 or 919:ff:m or a:0 or 0";
