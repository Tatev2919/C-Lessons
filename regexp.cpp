...
int main(){
	...
	regex ipv6("(((([1-9]|[A-F])([0-9]|[A-F]){2,3})|(([1-9]|[A-F])([0-9]|[A-F]))|([0-9]|[A-F]))\\:){3}(((([1-9]|[A-F])([0-9]|[A-F]){2,3})|(([1-9]|[A-F])([0-9]|[A-F]))|([0-9]|[A-F])))",regex_constants::icase);
	...
	string ip6_t = "IPv6 form is : 0:2F:AB:570 or 15:FFFa:2a:97B or 25a:2f5:2:147 but not 15::4b5:47a:49 or 919:ff:m or a:0 or 0";
